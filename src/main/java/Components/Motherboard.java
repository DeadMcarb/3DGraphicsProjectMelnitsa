...
public class Motherboard {
    ...
    public void init() {
        ...
        Panel powerConnectorUp1 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp2 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp3 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp4 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp5 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp6 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp7 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp8 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp9 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp10 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp11 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp12 = new Panel(2, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorUp13 = new Panel(5, 10, 25, Color.GRAY, on);
        ...
        Panel powerConnectorSide = new Panel(5, 10, 115, Color.GRAY, on);
        ...
        Panel powerConnectorSide1 = new Panel(2, 10, 115, Color.GRAY, on);
        ...
        Panel powerConnectorSide2 = new Panel(5, 10, 115, Color.GRAY, on);
        ...
        Panel powerConnectorCPU = new Panel(3, 10, 30, Color.GRAY, on);
        ...
        Panel powerConnectorCPU1 = new Panel(1, 10, 30, Color.GRAY, on);
        ...
        Panel powerConnectorCPU2 = new Panel(3, 10, 30, Color.GRAY, on);
        ...
        Panel powerConnectorCPU3 = new Panel(3, 10, 30, Color.GRAY, on);
        ...
        Panel powerConnectorCPU4 = new Panel(1, 10, 30, Color.GRAY, on);
        ...
        Panel powerConnectorCPU5 = new Panel(3, 10, 30, Color.GRAY, on);
        ...
        //LnR First 8-pin
        Panel powerConnectorCPU6 = new Panel(3, 10, 15, Color.GRAY, on);
        ...
        Panel powerConnectorCPU7 = new Panel(3, 10, 15, Color.GRAY, on);
        ...
        // LnR Second 8-pin
        Panel powerConnectorCPU8 = new Panel(3, 10, 15, Color.GRAY, on);
        ...
        Panel powerConnectorCPU9 = new Panel(3, 10, 15, Color.GRAY, on);
        ...
        Panel powerConnectorCPU10 = new Panel(2, 10, 15, Color.GRAY, on);
        ...
        Panel powerConnectorCPU11 = new Panel(2, 10, 15, Color.GRAY, on);
        ...
        Panel powerConnectorCPU12 = new Panel(2, 10, 15, Color.GRAY, on);
        ...
        Panel powerConnectorCPU13 = new Panel(2, 10, 15, Color.GRAY, on);
        ...
        Panel powerConnectorCPU14 = new Panel(2, 10, 15, Color.GRAY, on);
        ...
        Panel powerConnectorCPU15 = new Panel(2, 10, 15, Color.GRAY, on);
        ...
        CylinderP chipsetMounting2 = new CylinderP(4, 11, Color.WHITE, on);
        ...
        CylinderP battery = new CylinderP(20, 8, Color.BLACK, on);
        battery.setRotate(0, 0, 90);
        battery.setPosition(-130,175,-150);
        motherboard.getChildren().add(battery.getCylinder());

        CylinderP battery1 = new CylinderP(18, 8, Color.WHITE, on);
...
//        motherboard.getChildren().add(chip1.getPanel());
        ...
        Panel motherboard_radiator = new Panel(100, 270, 25, Color.BLACK, on);
        ...
        Panel motherboard_radiator_2 = new Panel(100, 20, 25, Color.BLACK, on);
...
//        motherboard.getChildren().add(motherboard_radiator_2.getPanel());
        ...
        Panel fin_1 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_1.setRotate(0, 90, -25);
        fin_1.setPosition(-110, -170, -285);
        motherboard.getChildren().add(fin_1.getPanel());

        Panel fin_2 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_2.setRotate(0, 90, -25);
        fin_2.setPosition(-110, -180, -285);
        motherboard.getChildren().add(fin_2.getPanel());

        Panel fin_3 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_3.setRotate(0, 90, -25);
        fin_3.setPosition(-110, -190, -285);
        motherboard.getChildren().add(fin_3.getPanel());

        Panel fin_4 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_4.setRotate(0, 90, -25);
        fin_4.setPosition(-110, -200, -285);
        motherboard.getChildren().add(fin_4.getPanel());

        Panel fin_5 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_5.setRotate(0, 90, -25);
        fin_5.setPosition(-110, -210, -285);
        motherboard.getChildren().add(fin_5.getPanel());

        Panel fin_6 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_6.setRotate(0, 90, -25);
        fin_6.setPosition(-110, -220, -285);
        motherboard.getChildren().add(fin_6.getPanel());

        Panel fin_7 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_7.setRotate(0, 90, -25);
        fin_7.setPosition(-110, -230, -285);
        motherboard.getChildren().add(fin_7.getPanel());

        Panel fin_8 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_8.setRotate(0, 90, -25);
        fin_8.setPosition(-110, -240, -285);
        motherboard.getChildren().add(fin_8.getPanel());

        Panel fin_9 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_9.setRotate(0, 90, -25);
        fin_9.setPosition(-110, -250, -285);
        motherboard.getChildren().add(fin_9.getPanel());

        Panel fin_10 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_10.setRotate(0, 90, -25);
        fin_10.setPosition(-110, -260, -285);
        motherboard.getChildren().add(fin_10.getPanel());

        Panel fin_11 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_11.setRotate(0, 90, -25);
        fin_11.setPosition(-110, -270, -285);
        motherboard.getChildren().add(fin_11.getPanel());

        Panel fin_12 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_12.setRotate(0, 90, -25);
        fin_12.setPosition(-110, -280, -285);
        motherboard.getChildren().add(fin_12.getPanel());

        Panel fin_13 = new Panel(108, 3, 10, Color.SADDLEBROWN, on);
        fin_13.setRotate(0, 90, -25);
        fin_13.setPosition(-110, -290, -285);
        motherboard.getChildren().add(fin_13.getPanel());

        Capacitor cap_1 = new Capacitor(-127,-290,-220, 0, 0, 0, motherboard, on);
        cap_1.init();

        Capacitor cap_2 = new Capacitor(-127,-268,-220, 0, 0, 0, motherboard, on);
        cap_2.init();

        Capacitor cap_3 = new Capacitor(-127,-246,-220, 0, 0, 0, motherboard, on);
        cap_3.init();

        Capacitor cap_4 = new Capacitor(-127,-224,-220, 0, 0, 0, motherboard, on);
        cap_4.init();

        Capacitor cap_5 = new Capacitor(-127,-202,-220, 0, 0, 0, motherboard, on);
        cap_5.init();

        Capacitor cap_6 = new Capacitor(-127,-180,-220, 0, 0, 0, motherboard, on);
        cap_6.init();

        Capacitor cap_7 = new Capacitor(-127,-158,-220, 0, 0, 0, motherboard, on);
        cap_7.init();

        Capacitor cap_8 = new Capacitor(-127,-116,-220, 0, 0, 0, motherboard, on);
        cap_8.init();

        Capacitor cap_9 = new Capacitor(-127,-116,-198, 0, 0, 0, motherboard, on);
        cap_9.init();

        Capacitor cap_10 = new Capacitor(-127,-116,-176, 0, 0, 0, motherboard, on);
        cap_10.init();

        Capacitor cap_11 = new Capacitor(-127,-116,-154, 0, 0, 0, motherboard, on);
        cap_11.init();

        Capacitor cap_12 = new Capacitor(-127,-116,-132, 0, 0, 0, motherboard, on);
        cap_12.init();
        ...
        Capacitor cap_13 = new Capacitor(-127,-120,95, 0, 0, 0, motherboard, on);
        cap_13.init();

        Capacitor cap_14 = new Capacitor(-127,-98,95, 0, 0, 0, motherboard, on);
        cap_14.init();
