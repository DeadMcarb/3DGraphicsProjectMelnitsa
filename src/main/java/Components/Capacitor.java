...
public class Capacitor {
    ...
    public Capacitor(int x, int y, int z, int xAngle, int yAngle, int zAngle, GroupExtended group, Boolean line) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.xAngle = xAngle;
